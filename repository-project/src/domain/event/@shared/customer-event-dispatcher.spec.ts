...
import SendMessageWhenAddressChangedHandler from "../customer/handler/send-message-when-address-changed.handler";
import SendMessage1WhenCustomerIsCreatedHandler from "../customer/handler/send-message1-when-customer-is-created.handler";
import SendMessage2WhenCustomerIsCreatedHandler from "../customer/handler/send-message2-when-customer-is-created.handler";
